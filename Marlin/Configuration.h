...
#define STRING_CONFIG_H_AUTHOR "(Kyle Guthrie, ANET E12-1.4T-2209SH-BLT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ANET E12"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  217    // (°C) Default nozzle temperature for G26.
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER+X_MIN_POS  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER+Y_MIN_POS  // Y point for Z homing
#endif
