 ...
 */
  ...
  #define BACK_PROBE_BED ( Y_BED_SIZE - (Y_BED_SIZE - (10 + PROBING_MARGIN))) // 300 - probe offset(-48) - 30 = 222
  #define RIGHT_PROBE_BED (X_BED_SIZE - (X_BED_SIZE - 48)) // 300 - probe offset(-10) - 30 = 260
  
  #define PROBING_MARGIN_LEFT PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT RIGHT_PROBE_BED
  #define PROBING_MARGIN_FRONT PROBING_MARGIN
  #define PROBING_MARGIN_BACK BACK_PROBE_BED
#endif
